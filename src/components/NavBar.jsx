  ...
  return (
    <div className="flex lg:px-12 px-5 justify-between fixed top-0 py-2 w-full items-center text-[#2E2E2E] backdrop-blur-md md:bg-white/40 bg-white/70 z-20">
      ...
      <div className="gap-10 flex items-center font-semibold cursor-pointer">
        ...
        >
          Plans
          <span className="h-0.5 rounded-4xl w-0 group-hover:w-[2.35rem] transition-all duration-500 ease-out bg-[#DD721D] block"></span>
        </li>
        <li
        ...
        >
          Contact
          <span className="h-0.5 rounded-4xl w-0 group-hover:w-14 transition-all duration-500 ease-out bg-[#DD721D] block"></span>
        </li>
        ...
        <li className={`list-none ${menuShow} md:hidden flex z-20`}>
          <img onClick={toggleDropdown} height="24" width="24" src={menu} />
        </li>
